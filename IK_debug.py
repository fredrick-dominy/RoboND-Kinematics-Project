...
def test_code(test_case):
    ...
    theta3 = pi / 2 - (angle_b + 0.036) # (video) 0.036 accounts for sag in link 4 of -0.54m
    ...
    your_ee = [FK[0,3],FK[1,3],2,3] # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
